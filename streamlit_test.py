...
def evaluation(airline_test, pred):
    ...
    st.markdown('<span style="color: LightPink; font-size:150%">**정확도**</span>: {0:.4f}'.format(acc), unsafe_allow_html=True)
    st.markdown('<span style="color: PaleVioletRed; font-size:150%">**정밀도**</span>: {0:.4f}'.format(pre), unsafe_allow_html=True)
    st.markdown('<span style="color: LightBlue; font-size:150%">**재현율**</span>: {0:.4f}'.format(rec), unsafe_allow_html=True)
    st.markdown('<span style="color: PaleTurquoise; font-size:150%">**fl score**</span>: {0:.4f}'.format(f1), unsafe_allow_html=True)
    st.markdown('<span style="color: DeepSkyBlue; font-size:150%">**roc_auc_score**</span>: {0:.4f}'.format(roc), unsafe_allow_html=True)
