...
# streamlit 앱 제목
st.markdown('**<center><span style="color: #000000; font-size:250%; ">Airline passenger satisfaction <br>Machine Learning Data view</span></center>**', unsafe_allow_html=True)
st.markdown('---')
# 데이터 읽어오기
