...
st.markdown('<center><span style="color: #666666; font-size:100%; line-height:2.2">원 데이터셋에 약 10만개의 데이터가 있으며, 훈련셋에는 약 26,000개의 데이터가 있다.</span></center>', unsafe_allow_html=True)
