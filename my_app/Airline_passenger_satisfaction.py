...
# streamlit 앱 제목
st.markdown('**<center><span style="color: #000000; font-size:250%; line-height:1.0">Airline passenger satisfaction \nMachine Learning Data view </span></center>**', unsafe_allow_html=True)
...
st.markdown('<center><span style="color: #666666; font-size:100%; line-height:2.2">원 데이터셋에 약 **10만개**의 데이터가 있으며, 훈련셋에는 약 **26,000개**의 데이터가 있다.</span></center>', unsafe_allow_html=True)
